...
import {
  ...
  progressWidths as progressWidths2,
          ...
          "button",
          {
            className: twMerge2(
              classNames(
                ...
                state === "uploading" ? `bg-blue-400 after:absolute after:left-0 after:h-full after:bg-blue-600 ${progressWidths2[uploadProgress]}` : "bg-blue-600"
              ),
