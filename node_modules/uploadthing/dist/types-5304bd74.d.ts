...
type AnyRuntime = "app" | "pages" | "web" | "express" | "fastify";
type MiddlewareFnArgs<TRequest, TResponse> = {
    req: TRequest;
    res: TResponse;
};
interface AnyParams {
...
type MiddlewareFn<TInput extends JSON | UnsetMarker, TOutput extends Record<string, unknown>, TArgs extends MiddlewareFnArgs<any, any>> = (opts: TArgs & (TInput extends UnsetMarker ? {} : {
    input: TInput;
